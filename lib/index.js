...
var nonComponentPropDynamic = function nonComponentPropDynamic(dyn) {
  return dyn.type !== PROP_COMPONENT;
};
...
function generateSpecElementDynamicChildCode(_ref4, childDesc, parentNodeVarId) {
  ...
  var isOnlyChild = childDesc.isOnlyChild;
...
function generateSpecElementStaticChildCode(_ref5, _ref6, parentNodeVarId) {
  ...
  var node = _ref6.node;
  var isOnlyChild = _ref6.isOnlyChild;
...
function generateSpecUpdateCode(t, xvdomApi, _ref9) {
  ...
  return t.functionExpression(null, [instId, pInstId], t.blockStatement([].concat(!tmpVar ? [] : [t.variableDeclaration('var', [t.variableDeclarator(tmpVar)])], updateDynamicPropCode, updateDynamicComponents)));
}
...
function generateRenderingCode(t, file, template) {
  var xvdomApi = {
    accessFunction: function accessFunction(apiFunc) {
...
module.exports = function (_ref17) {
  var t = _ref17.types;
  return {
    visitor: {
      JSXElement: {
