...
module.exports = class FunctionGenerator {
  ...
  get code() {
    ...
    const tmpVarDeclarators = tmpVars.map((value, i) => t.variableDeclarator(this.getTmpVarId(i), value));

    return t.functionExpression(null, _instId ? [_instId] : EMPTY_ARRAY, t.blockStatement([t.variableDeclaration('var', tmpVarDeclarators), ...statements, t.returnStatement(this.getTmpVarId(0))]));
  }
};