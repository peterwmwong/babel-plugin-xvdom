...
module.exports = (t, fileGlobals, valuesFnId, { dynamics, key }, fragId) => t.callExpression(fileGlobals.accessAPI('jsx'), [fragId, t.callExpression(valuesFnId, dynamics.map(({ astValueNode }) => astValueNode))]);