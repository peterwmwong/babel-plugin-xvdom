...
class JSXHTMLElement extends JSXElement {
  constructor(fragment, astJSXElement, parent) {
    ...
    this.children = filteredChildren.map(child => t.isJSXElement(child) ? createJSXElement(fragment, child, this) : new JSXValueElement(fragment, child, this, hasOnlyOneChild));
  }
}
